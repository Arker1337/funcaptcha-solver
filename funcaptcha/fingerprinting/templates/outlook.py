...
def generate_bda(fingerprint, cap_url):
    ...
    return [
        ...
        },
        {
            ...
            "value": "https://client-api.arkoselabs.com/v2/1.5.5/enforcement.fbfc14b0d793c6ef8359e0e4b4a91f67.html#B7D8911C-5CC8-A9A3-35B0-554ACEE604DA"
        },
        {
            "key": "client_config__sitedata_location_href",
            "value": "https://iframe.arkoselabs.com/B7D8911C-5CC8-A9A3-35B0-554ACEE604DA/index.html"
        },
        {
        ...
        },
        {
            ...
            "value": str(round(random.uniform(124.043479, 124.08), 14))
        }
    ]