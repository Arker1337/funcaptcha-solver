...
def generate_bda(fingerprint, cap_url):
    ...
    return [
        ...
        },
        {
            ...
            "value": "https://roblox-api.arkoselabs.com/v2/1.5.4/enforcement.cd12da708fe6cbe6e068918c38de2ad9.html#476068BF-9607-4799-B53D-966BE98E2B81"
        },
        {
        ...
        },
        {
            ...
            "value": str(round(random.uniform(122.043479, 124.08), 14))
        }
    ]