...
from overrides import overwrite
...
old_tls = create_ssl_context


def tls_hook(cert: typing.Optional = None,
             verify: bool = True,
             trust_env: bool = True,
             http2: bool = False):
    context = old_tls(cert, verify, trust_env, http2)
    ...
    def handle_request(
        ...
        req = httpcore.Request(
            ...
            url=httpcore.URL(
                ...
                host=overwrite(request.url.raw_host),
